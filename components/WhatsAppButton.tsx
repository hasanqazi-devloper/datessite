  ...
  return (
    ...
    >
      ...
      <div className="relative h-11 w-11 flex items-center justify-center shrink-0 rounded-full overflow-hidden">
        ...
        {/* Pure Vector Sharp Custom Brand SVG Icon */}
        <svg 
          viewBox="0 0 24 24" 
          className="w-5 h-5 text-white relative z-10 fill-current drop-shadow-[0_2px_5px_rgba(0,0,0,0.4)] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-105"
        >
